              ...
              <v-stepper v-model="step" flat tile elevation="0" class="accent">
                ...
                <v-stepper-items class="accent">
                  ...
                  <v-stepper-content step="3" class="px-0">
                    ...
                    <p class="text-body-1">
                      در صورت تمایل می‌توانید این دستگاه را با سرور هودا همگام سازی نمایید تا در صورت تعویض تلفن همراه یا پاک شدن برنامه، نیازی به تنظیم مجدد دستگاه نداشته باشید.
                    </p>
                    <v-btn color="success" block x-large rounded>
                      همگام سازی با سرور هودا
                    </v-btn>
